...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["modules-profile-profile-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppModulesProfileComponentsProfileEditorProfileEditorComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppModulesProfileComponentsProfileEditorProfileEditorComponentStyl(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppModulesProfileComponentsProfileEditorProfileEditorComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ProfileEditorComponent", function () {
    ...
    var projects_musicApp_src_environments_environment__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! projects/musicApp/src/environments/environment */
    ...
    var ProfileEditorComponent =
    /*#__PURE__*/
    function () {
      function ProfileEditorComponent(http, _matSnackBar) {
        _classCallCheck(this, ProfileEditorComponent);
      ...
      _createClass(ProfileEditorComponent, [{
        key: "setStep",
        ...
        value: function profileSubmit() {
          ...
          this.step++;
          var details = {};
          this.http.post("".concat(this.uri, "/profile/submit"), this.profileData).subscribe(function (res) {
            details = res['details'];
            console.log(details);

            _this._matSnackBar.open(details['message'], "", {
              duration: 1000
            });

            for (var a_data in _this.profileData) {
              _this.profileData[a_data] = '';
            }
          });
        }
      }, {
        key: "ngOnInit",
        value: function ngOnInit() {// this.http.get(`${this.uri}`).subscribe(res =>
    ...
    ProfileEditorComponent.ctorParameters = function () {
      return [{
    ...
    ProfileEditorComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'profile-editor',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./profile-editor.component.html */
      "../../node_modules/raw-loader/dist/cjs.js!./src/app/modules/profile/components/profile-editor/profile-editor.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./profile-editor.component.styl */
      "./src/app/modules/profile/components/profile-editor/profile-editor.component.styl"))["default"]]
  ...
  function srcAppModulesProfileProfileRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_profile_editor_profile_editor_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./components/profile-editor/profile-editor.component */
    "./src/app/modules/profile/components/profile-editor/profile-editor.component.ts");

    var routes = [{
      path: '',
      component: _components_profile_editor_profile_editor_component__WEBPACK_IMPORTED_MODULE_3__["ProfileEditorComponent"]
    }];
  ...
  function srcAppModulesProfileProfileModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_profile_editor_profile_editor_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./components/profile-editor/profile-editor.component */
    "./src/app/modules/profile/components/profile-editor/profile-editor.component.ts");
    /* harmony import */
    ...
    ProfileModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      ...
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _profile_routing_module__WEBPACK_IMPORTED_MODULE_4__["ProfileRoutingModule"], _material_material_module__WEBPACK_IMPORTED_MODULE_3__["MaterialModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["FormsModule"]]
    })], ProfileModule);
    /***/
  }
}]);
